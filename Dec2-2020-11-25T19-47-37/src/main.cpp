...
RFDrive.startRotateTo(driveInches(39),vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(39),vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(39),vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
//turn left 
task::sleep(1700);
...
RBDrive.resetRotation();
 task::sleep(100);
LFDrive.startRotateTo(-200,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
RFDrive.startRotateTo(200,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
LBDrive.startRotateTo(-200,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
RBDrive.startRotateTo(200,vex::rotationUnits::deg, 100,vex::velocityUnits::pct);
//turn left 
  task::sleep(430);
 RBDrive.stop();
 LBDrive.stop();
...
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(24),vex::rotationUnits::deg, 30,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(24),vex::rotationUnits::deg, 30,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(24),vex::rotationUnits::deg, 30,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(24),vex::rotationUnits::deg, 30,vex::velocityUnits::pct);
task::sleep(2000);
