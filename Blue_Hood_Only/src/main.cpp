...
TRollers.stop();
task::sleep(100);
/*LFDrive.startRotateTo(driveInches(36),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(36),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(36),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(36),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
LBDrive.resetRotation();
LFDrive.resetRotation();
RFDrive.resetRotation();
...
waitUntil(Inertia.rotation(degrees) >= 58 );
...
LFDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
...
LFDrive.startRotateTo(driveInches(-42),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RBDrive.startRotateTo(driveInches(-42),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
LIntake.stop();
RIntake.stop();
LBDrive.resetRotation();
...
RFDrive.resetRotation();
RBDrive.resetRotation();
LFDrive.spin(reverse, 50,vex::velocityUnits::pct);
LBDrive.spin(reverse, 50,vex::velocityUnits::pct);
RFDrive.spin(forward, 50,vex::velocityUnits::pct);
RBDrive.spin(forward, 50,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) <= -113);
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
LIntake.spin(directionType::fwd, 100, velocityUnits::pct);
RIntake.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(21),vex::rotationUnits::deg, 25,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(21),vex::rotationUnits::deg, 25,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(21),vex::rotationUnits::deg, 25,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(21),vex::rotationUnits::deg, 25,vex::velocityUnits::pct);
task::sleep(3000);
LIntake.stop();
RIntake.stop();
LBDrive.resetRotation();
...
/*LFDrive.startRotateTo(driveInches(49),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(49),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(49),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(49),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
LBDrive.resetRotation();
LFDrive.resetRotation();
RFDrive.resetRotation();
...
waitUntil(Inertia.rotation(degrees) <= 132.2 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
LFDrive.startRotateTo(driveInches(62),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(62),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(62),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(62),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2250);
Intakes.stop();
LFDrive.spin(forward, 75,vex::velocityUnits::pct);
LBDrive.spin(forward, 75,vex::velocityUnits::pct);
RFDrive.spin(reverse, 75,vex::velocityUnits::pct);
RBDrive.spin(reverse, 75,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) >= 115 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(34),vex::rotationUnits::deg, 95,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(34),vex::rotationUnits::deg, 95,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(34),vex::rotationUnits::deg, 95,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(34),vex::rotationUnits::deg, 95,vex::velocityUnits::pct);
task::sleep(1450);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
BRollers.spin(directionType::rev, 100, velocityUnits::pct);
task::sleep(500);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(-8),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
task::sleep(100);
Intakes.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(46),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RFDrive.spin(reverse, 75,vex::velocityUnits::pct);
RBDrive.spin(reverse, 75,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) >= -47 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(16),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(-11),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(-11),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(-11),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(-11),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(500);
...
RFDrive.spin(forward, 75,vex::velocityUnits::pct);
RBDrive.spin(forward, 75,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) <= -163 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
RFDrive.spin(reverse, 75,vex::velocityUnits::pct);
RBDrive.spin(reverse, 75,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) >= -80 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
task::sleep(100);
Intakes.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(50),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(50),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(50),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(50),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
Intakes.stop();
LBDrive.resetRotation();
LFDrive.resetRotation();
...
RFDrive.startRotateTo(driveInches(-13),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(31),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(-17),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
task::sleep(250);
Intakes.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(48),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(48),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(48),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(48),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
Intakes.stop();
LBDrive.resetRotation();
LFDrive.resetRotation();
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(30),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(30),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(30),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(30),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(1200);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
BRollers.spin(directionType::rev, 100, velocityUnits::pct);
Inertia.calibrate();
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(-6),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(14),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(14),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(14),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(14),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(500);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
BRollers.spin(directionType::rev, 100, velocityUnits::pct);
task::sleep(1500);
...
int driveTask() {
  while(1) {
    ...
    LFDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value() + Controller1.Axis1.value()), vex::velocityUnits::pct);
    RFDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value() - Controller1.Axis1.value()), vex::velocityUnits::pct);
    LBDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value() + Controller1.Axis1.value()), vex::velocityUnits::pct);
    RBDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value() - Controller1.Axis1.value()), vex::velocityUnits::pct);
  }
  return(0);
}
