...
LIntake.spin(directionType::fwd, 100, velocityUnits::pct);
RIntake.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 80,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 80,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 80,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(22),vex::rotationUnits::deg, 80,vex::velocityUnits::pct);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
