...
vex::motor LFDrive(vex::PORT12, vex::gearSetting::ratio18_1,false);
vex::motor RFDrive(vex::PORT11, vex::gearSetting::ratio18_1,true);
vex::motor LBDrive(vex::PORT4, vex::gearSetting::ratio18_1,false);
vex::motor RBDrive(vex::PORT3, vex::gearSetting::ratio18_1,true);
