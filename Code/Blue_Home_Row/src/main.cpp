...
LFDrive.startRotateTo(driveInches(-27),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(-27),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(-27),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(-27),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(2000);
LIntake.stop();
RIntake.stop();
LBDrive.resetRotation();
...
RFDrive.spin(reverse, 75,vex::velocityUnits::pct);
RBDrive.spin(reverse, 75,vex::velocityUnits::pct);
waitUntil(Inertia.rotation(degrees) >= 196 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
RBDrive.resetRotation();
task::sleep(250);
LFDrive.startRotateTo(driveInches(78),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(78),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(78),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(78),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(3000);
LBDrive.resetRotation();
LFDrive.resetRotation();
RFDrive.resetRotation();
...
waitUntil(Inertia.rotation(degrees) <= 130 );
LBDrive.stop(vex::brakeType::hold);
LFDrive.stop(vex::brakeType::hold);
RFDrive.stop(vex::brakeType::hold);
RBDrive.stop(vex::brakeType::hold);
...
LIntake.spin(directionType::fwd, 100, velocityUnits::pct);
RIntake.spin(directionType::fwd, 100, velocityUnits::pct);
LFDrive.startRotateTo(driveInches(28),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(28),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(28),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(28),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(500);
TRollers.spin(directionType::rev, 100, velocityUnits::pct);
BRollers.spin(directionType::rev, 100, velocityUnits::pct);
task::sleep(3000);
