...
LFDrive.startRotateFor(707,vex::rotationUnits::deg,100,vex::velocityUnits::pct);
RFDrive.startRotateFor(707,vex::rotationUnits::deg,100,vex::velocityUnits::pct);
LBDrive.startRotateFor(707,vex::rotationUnits::deg,100,vex::velocityUnits::pct);
RBDrive.startRotateFor(707,vex::rotationUnits::deg,100,vex::velocityUnits::pct);
TRollers.spin(directionType::rev, 70, velocityUnits::pct);
BRollers.spin(directionType::rev, 70, velocityUnits::pct);
task::sleep(2500);
TRollers.stop();
BRollers.stop();
LFDrive.startRotateFor(-600,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
RFDrive.startRotateFor(-600,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
LBDrive.startRotateFor(-600,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
RBDrive.startRotateFor(-600,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
 task::sleep(1000);
 LFDrive.startRotateFor(500,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
RFDrive.startRotateFor(-500,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
LBDrive.startRotateFor(500,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
RBDrive.startRotateFor(-500,vex::rotationUnits::deg,200,vex::velocityUnits::pct);
 task::sleep(900);
