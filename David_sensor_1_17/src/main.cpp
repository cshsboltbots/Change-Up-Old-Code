...
LFDrive.startRotateTo(driveInches(43),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RFDrive.startRotateTo(driveInches(43),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
LBDrive.startRotateTo(driveInches(43),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
RBDrive.startRotateTo(driveInches(43),vex::rotationUnits::deg, 90,vex::velocityUnits::pct);
task::sleep(1000);
LFDrive.spin(forward);
LBDrive.spin(forward);
RFDrive.spin(reverse);
...
int driveTask() {
  while(1) {
    LFDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value()*2 + Controller1.Axis1.value()/2), vex::velocityUnits::pct);
    RFDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value()*2 - Controller1.Axis1.value()/2), vex::velocityUnits::pct);
    LBDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value()*2 + Controller1.Axis1.value()/2), vex::velocityUnits::pct);
    RBDrive.spin(vex::directionType::fwd, (Controller1.Axis3.value()*2 - Controller1.Axis1.value()/2), vex::velocityUnits::pct);
  }
  return(0);
}
